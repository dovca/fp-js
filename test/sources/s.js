module.exports = (functionsModuleName) => () => {
	...
	describe(`${functionsModuleName}/s - Subtract`, function () {
		...
		it('Should work with one argument', function () {
			const testCases = [
				{output: () => s(-2), expected: -3},
				{output: () => s(-1), expected: -2},
				{output: () => s(0), expected: -1},
				{output: () => s(1), expected: 0},
				{output: () => s(2), expected: 1},

				{output: () => s(false), expected: -1},
				{output: () => s(true), expected: 0},
			];
